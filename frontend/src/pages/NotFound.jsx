    ...
    <div className="bg-white pt-24 pb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-gray-500">Explore our exquisite jewelry collection</p>
                </div>
              </Link>
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-gray-500">Get in touch with our customer service team</p>
                </div>
              </Link>
            </div>
      ...
      <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white py-16 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-3xl font-bold mb-6">Discover DiamondLux</h2>
            <p className="text-xl max-w-2xl mx-auto mb-8">
              Explore our collection of exquisite jewelry pieces, crafted with precision and elegance.
            </p>
            <Link 
              to="/products"
