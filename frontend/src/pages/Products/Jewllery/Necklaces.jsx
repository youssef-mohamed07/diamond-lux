...
const Necklaces = () => {
  ...
  useEffect(() => {
    ...
    if (shapes.length > 0) {
      filteredProducts = filteredProducts.filter(
        (necklace) => necklace.shape && shapes.includes(necklace.shape)
      );
    }
    ...
    if (colors.length > 0) {
      filteredProducts = filteredProducts.filter(
        (necklace) => necklace.col && colors.includes(necklace.col)
      );
    }
    ...
    if (clarities.length > 0) {
      filteredProducts = filteredProducts.filter(
        (necklace) => necklace.clar && clarities.includes(necklace.clar)
      );
    }
    ...
    if (cuts.length > 0) {
      filteredProducts = filteredProducts.filter(
        (necklace) => necklace.cut && cuts.includes(necklace.cut)
      );
    }
    ...
    if (polishes.length > 0) {
      filteredProducts = filteredProducts.filter(
        (necklace) => necklace.pol && polishes.includes(necklace.pol)
      );
    }
    ...
    if (symmetries.length > 0) {
      filteredProducts = filteredProducts.filter(
        (necklace) => necklace.symm && symmetries.includes(necklace.symm)
      );
    }
    ...
    if (fluorescences.length > 0) {
      filteredProducts = filteredProducts.filter(
        (necklace) => necklace.flo && fluorescences.includes(necklace.flo)
      );
    }
    ...
    if (labs.length > 0) {
      filteredProducts = filteredProducts.filter(
        (necklace) => necklace.lab && labs.includes(necklace.lab)
      );
    }
  ...
  useEffect(() => {
    if (necklaces && necklaces.length > 0) {
      ...
      setUniqueClarities([
        ...new Set(necklaces.filter((p) => p.clar).map((p) => p.clar)),
      ]);
      setUniqueCuts([
        ...new Set(necklaces.filter((p) => p.cut).map((p) => p.cut)),
      ]);
      setUniquePolishes([
        ...new Set(necklaces.filter((p) => p.pol).map((p) => p.pol)),
      ]);
      setUniqueSymmetries([
        ...new Set(necklaces.filter((p) => p.symm).map((p) => p.symm)),
      ]);
      setUniqueFluorescences([
        ...new Set(necklaces.filter((p) => p.flo).map((p) => p.flo)),
      ]);
      setUniqueLabs([
        ...new Set(necklaces.filter((p) => p.lab).map((p) => p.lab)),
      ]);
                  ...
                  {filteredCategories.length > 0 ? (
                    ...
                    <div className="p-6 bg-gray-50 rounded-lg text-center">
                      <p className="text-gray-500">
                        No diamond shapes available for the current necklaces.
                      </p>
                    </div>
                  )}
                </div>
