...
const EngagementRings = () => {
  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      ...
      if (engagementRings && engagementRings.length > 0) {
        ...
        setFilterProducts(engagementRings);
  ...
  }, [extractUniqueFilterValues, engagementRings, limit]);
  ...
  useEffect(() => {
    // If engagement rings are already available in context, use them initially
    if (engagementRings && engagementRings.length > 0) {
      setProducts(engagementRings);
      setFilterProducts(engagementRings);
      setTotalPages(Math.ceil(engagementRings.length / limit));
  ...
  }, [fetchProducts, engagementRings, limit]);
