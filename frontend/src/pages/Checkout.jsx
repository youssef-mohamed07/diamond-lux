          ...
          >
            ...
            <div className="mb-8">
              <div className="flex items-center justify-center">
                ...
                <div className={`w-12 h-1 mx-2 ${step >= 2 ? 'bg-gray-900' : 'bg-gray-200'}`}></div>
                ...
                <div className={`w-12 h-1 mx-2 ${step >= 3 ? 'bg-gray-900' : 'bg-gray-200'}`}></div>
                  ...
                  {step === 1 && (
                    <div>
                      <div className="flex items-center mb-4">
                        <FaShippingFast className="text-gray-900 mr-2" size={20} />
