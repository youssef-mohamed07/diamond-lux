    ...
    <div className="bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="uppercase tracking-[0.2em] text-sm font-light">Custom Design</span>
            </div>
            <h1 className="text-4xl font-extrabold sm:text-5xl lg:text-6xl mb-6">Request a Quote</h1>
            <p className="text-xl text-gray-200 max-w-3xl">
              Let us create the perfect custom jewelry piece for your special occasion. Our expert craftsmen will bring your vision to life.
            </p>
          </motion.div>
        </div>
      </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center p-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">1. Submit Request</h3>
                <p className="text-gray-600">
                  Fill out our custom quote form with your jewelry preferences and requirements.
                </p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">2. Receive Quote</h3>
                <p className="text-gray-600">
                  Our experts will review your request and provide a detailed quote within 48 hours.
                </p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">3. Design Process</h3>
                <p className="text-gray-600">
                  Work with our designers to refine your vision and approve the final design.
                </p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">4. Creation & Delivery</h3>
          <p className="text-gray-600">
                  Our master craftsmen create your piece and deliver it in a luxury presentation box.
          </p>
              </div>
            </div>
          </motion.div>
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900">Request Your Custom Quote</h2>
              <div className="w-16 h-1 bg-gradient-to-r from-gray-900 to-gray-700 mx-auto mt-4"></div>
              <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
                Whether you're looking for a custom engagement ring, a special anniversary gift, or a unique piece of fine jewelry, our team is here to bring your vision to life.
              </p>
            </div>
                ...
                {submitSuccess ? (
                  ...
                  >
                    ...
                    <p className="text-gray-600 mb-6">
                      Your custom jewelry request has been submitted successfully. One of our jewelry experts will contact you within 48 hours to discuss your requirements in detail.
                    </p>
                    <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gray-50 p-6 rounded-lg">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Custom Engagement Ring</p>
                  </div>
                </div>
                <p className="text-gray-600 italic">
                  "The custom engagement ring DiamondLux created exceeded all my expectations. The attention to detail and craftsmanship is extraordinary. My fiancée was absolutely speechless!"
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Anniversary Necklace</p>
                  </div>
                </div>
                <p className="text-gray-600 italic">
                  "I wanted something unique for our 10th anniversary. The team at DiamondLux helped me design a stunning sapphire necklace that perfectly captures our journey together."
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <div className="flex items-center mb-4">
                  <div className="h-10 w-10 rounded-full bg-gray-300 mr-3"></div>
                  <div>
                    <h4 className="font-medium text-gray-900">Sophia Rodriguez</h4>
                    <p className="text-sm text-gray-500">Family Heirloom Redesign</p>
                  </div>
                </div>
                <p className="text-gray-600 italic">
                  "DiamondLux transformed my grandmother's outdated jewelry into a modern piece I can wear every day. They respected the sentimental value while creating something fresh and beautiful."
                </p>
              </div>
            </div>
          </motion.div>
