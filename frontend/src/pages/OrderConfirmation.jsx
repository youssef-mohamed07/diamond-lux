    ...
    <div className="bg-white pt-16 sm:pt-24 pb-8 sm:pb-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900 mb-3 sm:mb-4">Thank You for Your Order!</h1>
          <p className="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8">
            Your order has been received and is being processed.
          </p>
          
          <div className="bg-gray-50 rounded-lg p-4 sm:p-8 mb-6 sm:mb-8 text-left">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">Order Details</h2>
            <div className="border-t border-b border-gray-200 py-3 sm:py-4 mb-3 sm:mb-4">
              <div className="flex justify-between mb-2">
                ...
                <span className="text-sm sm:text-base font-medium text-gray-900">{orderNumber}</span>
              </div>
              <div className="flex justify-between mb-2">
                <span className="text-sm sm:text-base text-gray-600">Date:</span>
                <span className="text-sm sm:text-base font-medium text-gray-900">{new Date().toLocaleDateString()}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-sm sm:text-base text-gray-600">Status:</span>
                <span className="text-sm sm:text-base font-medium text-green-600">Confirmed</span>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white p-4 sm:p-6 rounded-lg mb-4 sm:mb-6">
              <div className="flex items-center mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-bold">DiamondLux Premium Service</h3>
              </div>
              <p className="text-sm sm:text-base mb-3 sm:mb-4">
                Your exquisite jewelry will be carefully packaged in our signature gift box and 
                delivered with the utmost care. Each piece includes a certificate of authenticity.
              </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 sm:mt-16">
        <div className="bg-gray-50 rounded-lg p-4 sm:p-8">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 text-center">What Happens Next?</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-1 sm:mb-2">Order Processing</h3>
              <p className="text-sm sm:text-base text-gray-600">
                Our team will verify your order and prepare your items for shipment.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-1 sm:mb-2">Shipping</h3>
              <p className="text-sm sm:text-base text-gray-600">
                Your jewelry will be carefully packaged and shipped to your address.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-1 sm:mb-2">Delivery</h3>
              <p className="text-sm sm:text-base text-gray-600">
                Receive your exquisite DiamondLux jewelry and enjoy your new piece.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-base sm:text-xl max-w-2xl mx-auto mb-6 sm:mb-8">
              Follow us on social media for styling tips, new collection announcements, and exclusive offers.
            </p>
