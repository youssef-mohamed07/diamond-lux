  ...
  return (
    <div className="bg-white pt-24 pb-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="mx-auto w-24 h-24 mb-6 text-green-500">
          ...
          <div className="bg-gray-50 rounded-lg p-8 mb-8 text-left">
            ...
            <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white p-6 rounded-lg mb-6">
              <div className="flex items-center mb-4">
                <FaGem className="h-6 w-6 mr-3" />
                <h3 className="text-xl font-bold">DiamondLux Premium Service</h3>
              </div>
              <p className="mb-4">
