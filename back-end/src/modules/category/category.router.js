...
import { AddCategory, deleteCategory, getAllCategory, getCategoryById, updateCategory, updateDiamondShapeImage } from "./category.controller.js";
...
CategoryRouter.route('/:id/image').post(uploadSinleFile('img','diamond-shapes'), updateDiamondShapeImage)
